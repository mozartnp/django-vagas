...
class CandidatoTestCase(LiveServerTestCase):
    ...
    #     self.assertEqual(
    #         self.browser.current_url,
    #         self.live_server_url + '/candidato/vizualizandoperfil', 
    ...
    #     cookie = self.c.cookies['sessionid']
    #     self.browser.get(self.live_server_url + '/candidato/vizualizandoperfil')
    #     self.browser.add_cookie({'name': 'sessionid', 'value': cookie.value, 'secure': False, 'path': '/'})
    #     self.browser.refresh()
    #     self.browser.get(self.live_server_url + '/candidato/vizualizandoperfil')
    ...
    def test_vizualizar_perfil_candidato(self):
        ...
        self.assertEqual(
            self.browser.current_url,
            self.live_server_url + '/candidato/vizualizandoperfil', 
            msg='Foi encontrada outra pagina, e não a url /candidato/vizualizandoperfil.'
        )
        ...
        aviso = self.browser.find_element_by_css_selector('section[data-info="mensagemBoasVizualizandoPerfil"')
        self.assertEqual(
            aviso.text,
            'Olá {}\nEste é o seu perfil.'.format(PerfilModel.objects.get(user_id= self.user_com_perfil.id)),
